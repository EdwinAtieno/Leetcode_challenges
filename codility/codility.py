...
def find_pairs(numbers):
    """
    Finds all pairs of numbers in the array `numbers` where the last digit of the first selected number is the same as
...
def find_pairs(numbers: list) -> int:
    """
    Finds all pairs of numbers in the array `numbers` where the last digit of the first selected number is
    the same as the first digit of the second number.
